...
namespace WinBox_Maker
{
    public partial class EditorForm : Form
    {
        ...
        public EditorForm(WinBoxProject winBoxProject, bool skipConstructor = false)
        {
        ...
        */
        ...
        {
            LockForm();
            string? name = await winBoxProject.SelectResourceAsync(UpdateProcessName, UpdateProcessValue, Program.executableFilter, Path.Combine(winBoxProject.resourcesDirectoryPath, "program"), true);
            if (name != null)
            {
        ...
        private void scriptgeneration_applyBCD_CheckedChanged(object sender, EventArgs e)
        {
            if (guiEventsLock) return;

            winBoxProject.winBoxConfig.scriptgeneration_applyBCD = scriptgeneration_applyBCD.Checked;
            winBoxProject.SaveConfig();
        }
